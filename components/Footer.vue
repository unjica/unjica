<template>
  <div class="m-2 bg-purple-200 relative rounded-sm py-5 flex flex-col items-center justify-between shadow-md text-black">
    <Logo />

    <div class="flex gap-x-5 py-8">
      <a
        href="https://www.linkedin.com/in/sanja-malovi%C4%87-034519184/"
        aria-label="Linkedin"
        title="Linkedin"
        target="_blank"
        class="scale-5"
      ...
      <a
        href="https://www.facebook.com/sanja.malovic22/"
        aria-label="Facebook"
        title="Facebook"
        target="_blank"
        class="scale-5"
    ...
    <a href="mailto:sanja.malovic2@gmail.com" class="hover:text-purple-400 transition">sanja.malovic2@gmail.com</a>

    <span class="text-center flex items-center justify-center opacity-50">
      unjica © {{ year }} | Sanja Malovic
    </span>
  </div>
</template>
